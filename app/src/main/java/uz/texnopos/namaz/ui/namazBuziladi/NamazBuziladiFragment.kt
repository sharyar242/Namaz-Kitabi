...
class NamazBuziladiFragment(): Fragment(R.layout.fragment_namaz_buziladi),
    NamazBuziladiView {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenter.getNamazBuziladiArticle(13)
        (requireActivity() as MainActivity).supportActionBar?.title = "Биз хаққымизда"
    }
    override fun setNamazBuziladiArticle(article: Article) {

...
class JumaNamazFragment(): Fragment(R.layout.fragment_juma_namaz),
    JumaNamazView {
    private lateinit var presenter : JumaNamazPresenter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenter = JumaNamazPresenter(dao, this)
        presenter.getJumaNamazArticle(13)
        (requireActivity() as MainActivity).supportActionBar?.title = "Биз хаққымизда"
    }

    override fun setJumaNamazArticle(article: Article) {

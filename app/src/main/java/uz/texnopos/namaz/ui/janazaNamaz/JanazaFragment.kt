...
class JanazaFragment(): Fragment(R.layout.fragment_janaza_namaz),
    JanazaView {

    private lateinit var presenter : JanazaPresenter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenter = JanazaPresenter(dao, this)
        presenter.getJanazaArticle(13)
        (requireActivity() as MainActivity).supportActionBar?.title = "Биз хаққымизда"
    }
    override fun setJanazaArticle(article: Article) {

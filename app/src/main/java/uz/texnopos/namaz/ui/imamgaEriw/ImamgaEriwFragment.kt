...
import uz.texnopos.namaz.ui.namaz.NamazPresenter

class ImamgaEriwFragment(): Fragment(R.layout.fragment_imamgi_eriw),
    ImamgaEriwView {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenter.getImamgaEriwArticle(13)
        (requireActivity() as MainActivity).supportActionBar?.title = "Биз хаққымизда"
    }
    override fun setImamgaEriwArticle(article: Article) {

...
import uz.texnopos.namaz.ui.namaz.NamazView

class NamazZikirlerFragment(): Fragment(R.layout.fragment_namaz_zikirler),
    NamazZikirlerView {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenter.getNamazZikirlerArticle(13)
        (requireActivity() as MainActivity).supportActionBar?.title = "Биз хаққымизда"
    }
    override fun setNamazZikirlerArticle(article: Article) {
